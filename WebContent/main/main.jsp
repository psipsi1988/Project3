					...
					<table cellpadding="0" cellspacing="0" border="0">
						...
						<tr>
							...
							<td>
								...
								<input type="text" name="user_id" value="<%= user==null ? "" : user %>" class="login_input" tabindex="1" />
							...
							<td rowspan="2">
								<input type="image" tabindex="4" src="../images/login_btn01.gif" alt="로그인" />
							</td>
						...
						<tr>
							...
							<td><input type="password" name="user_pw" value="" tabindex="2"  class="login_input" /></td>
						</tr>
						
					</table>
					<p>
						<input type="checkbox" name="id_save" value="Y" tabindex="3" <% if(user.length()!=0){ %>checked="checked" <% } %>/>
