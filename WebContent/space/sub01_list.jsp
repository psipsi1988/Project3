...
<%
	...
	*/
	...
	//limit의 두 번째 인자  :가져올 레코드의 개수
	int end = pageSize;




	//게시물의 범위를 Map컬렉션에 저장하고 DAO로 전달
	...
	<div id="wrap">
		...
		%>	
            ...
            <tr>
            	...
            	<td class="text-center">
            		<a href="sub01_view.jsp?num=<%=dto.getNum()%>
		...
		%>
				...
				<div class="row">
					...
					<% if(bname.equals("free") || bname.equals("photo") || bname.equals("calendar") || bname.equals("info")){ %>
